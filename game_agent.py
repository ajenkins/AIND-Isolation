...
class MinimaxPlayer(IsolationPlayer):
    ...
    def _min_value(self, game, remaining_depth):
        ...
        for move in game.get_legal_moves():
            smallest = min(smallest, self._max_value(game.forecast_move(move), remaining_depth - 1))
        return smallest
    ...
    def _max_value(self, game, remaining_depth):
        ...
        biggest = float('-inf')
        for move in game.get_legal_moves():
            biggest = max(biggest, self._min_value(game.forecast_move(move), remaining_depth - 1))
        return biggest
...
class AlphaBetaPlayer(IsolationPlayer):
    ...
    def _min_value(self, game, alpha, beta, remaining_depth):
        """ Return the score for the current player if the game is over,
        otherwise return the minimum value over all legal child
        nodes.
        """
